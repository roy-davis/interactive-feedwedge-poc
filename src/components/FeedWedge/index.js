...
const FeedWedge = props => {
	...
	for (let i = 0; i < props.covers.length; i++) {
		...
		let available = (props.covers[i].value)/32;
		let avail_y = 192 - available;
		histogram_cover_bars.push(
			<rect x={histogram_x} y={avail_y} className="fw_bar_available" width={histogram_bar_width} height={available} />
		)
		avail_y = 192 - histogram_residual;
		histogram_residual_bars.push(
			<rect x={histogram_x} y={avail_y} className="fw_bar_residual" width={histogram_bar_width} height={histogram_residual} />
		)
	...
	let target_line = <line className="fw_target" x1="0" y1={target_start} x2={histogram_width} y2={target_end} stroke-width="2" />
  ...
  return (
	<div className="fw_container">
		...
		<div className="fw_histogram_container">
			...
			<svg	className="y_axis"
				...
				<line className="st0a" x1="0" y1="32" x2={histogram_width} stroke-dasharray="2 2" y2="32"/>
				<line className="st0a" x1="0" y1="64" x2={histogram_width} stroke-dasharray="2 2" y2="64"/>
				<line className="st0a" x1="0" y1="96" x2={histogram_width} stroke-dasharray="2 2" y2="96"/>
				<line className="st0a" x1="0" y1="128" x2={histogram_width} stroke-dasharray="2 2" y2="128"/>
				<line className="st0a" x1="0" y1="160" x2={histogram_width} stroke-dasharray="2 2" y2="160"/>
